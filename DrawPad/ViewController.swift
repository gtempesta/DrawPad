...
// qui indicazioni
// https://github.com/dragosholban/DrawPad/blob/master/DrawPad/ViewController.swift

// modificato un metodo
// e il modo in cui estraggo optional (con un unico punto esclamativo invece che punto di domanda ogni
// volta)
